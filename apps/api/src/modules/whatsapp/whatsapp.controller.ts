  ...
  private getSampleData(eventType: string): Record<string, string> {
    const samples: Record<string, Record<string, string>> = {
      ...
      OPERATIONAL_RECONCILIATION: {
        ...
        inventoryIntegrityIssueCount: "1",
        openInventoryIssueCount: "1",
        reviewedInventoryIssueCount: "0",
        resolvedInventoryIssueCount: "0",
        ignoredInventoryIssueCount: "0",
        criticalOpenInventoryIssueCount: "1",
