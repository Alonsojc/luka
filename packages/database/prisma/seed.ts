...
async function main() {
  ...
  const branches = [
    { code: "CEDIS01", name: "CEDIS Central", city: "Ciudad de México", state: "CMX", address: "Parque Industrial Vallejo, Nave 5", postalCode: "07700", branchType: "CEDIS" },
    { code: "CDMX01", name: "Luka Polanco", city: "Ciudad de México", state: "CMX", address: "Av. Presidente Masaryk 123", postalCode: "11560", branchType: "TIENDA" },
    { code: "CDMX02", name: "Luka Roma", city: "Ciudad de México", state: "CMX", address: "Calle Orizaba 45", postalCode: "06700", branchType: "TIENDA" },
    { code: "GDL01", name: "Luka Providencia", city: "Guadalajara", state: "JAL", address: "Av. Providencia 890", postalCode: "44630", branchType: "TIENDA" },
    { code: "MTY01", name: "Luka San Pedro", city: "Monterrey", state: "NLE", address: "Calzada del Valle 200", postalCode: "66220", branchType: "TIENDA" },
    { code: "QRO01", name: "Luka Juriquilla", city: "Querétaro", state: "QUE", address: "Blvd. Juriquilla 500", postalCode: "76226", branchType: "TIENDA" },
    { code: "CAN01", name: "Luka Cancún", city: "Cancún", state: "ROO", address: "Blvd. Kukulcán km 12", postalCode: "77500", branchType: "TIENDA" },
    { code: "PUE01", name: "Luka Angelópolis", city: "Puebla", state: "PUE", address: "Blvd. del Niño Poblano 2510", postalCode: "72197", branchType: "TIENDA" },
    { code: "MER01", name: "Luka Montejo", city: "Mérida", state: "YUC", address: "Paseo de Montejo 480", postalCode: "97000", branchType: "TIENDA" },
    { code: "TIJ01", name: "Luka Zona Río", city: "Tijuana", state: "BCN", address: "Blvd. Sánchez Taboada 100", postalCode: "22320", branchType: "TIENDA" },
    { code: "LEON01", name: "Luka Centro Max", city: "León", state: "GUA", address: "Blvd. Adolfo López Mateos 1102", postalCode: "37150", branchType: "TIENDA" },
  ];
  ...
  console.log("Legal entities created:", legalEntities.length, "(CEDIS01, TIJ01, LEON01 remain unassigned)");
  ...
  await prisma.userBranchRole.upsert({
    where: { userId_branchId_roleId: { userId: owner.id, branchId: branchIds["CDMX01"], roleId: roles["owner"] } },
    update: {},
  ...
  await prisma.userBranchRole.upsert({
    where: { userId_branchId_roleId: { userId: investor.id, branchId: branchIds["CDMX01"], roleId: roles["investor"] } },
    update: {},
    create: { userId: investor.id, branchId: null, roleId: roles["investor"] },
  });

  console.log("Users created: admin@lukapoke.com / inversionista@lukapoke.com (password: Admin123!)");
  ...
  const isrMonthly2026 = [
    ...
    { lower: 49233.01, upper: 93993.90, fixed: 9236.89, rate: 0.30 },
    { lower: 93993.91, upper: 125325.20, fixed: 22665.17, rate: 0.32 },
  ...
  const imssRates2026 = [
    ...
    { branch: "enfermedades_maternidad_excedente", employerRate: 0.011, employeeRate: 0.004, ceiling: 25 },
    { branch: "enfermedades_maternidad_prestaciones", employerRate: 0.007, employeeRate: 0.0025, ceiling: 25 },
    { branch: "enfermedades_maternidad_gastos_medicos", employerRate: 0.0105, employeeRate: 0.00375, ceiling: 25 },
