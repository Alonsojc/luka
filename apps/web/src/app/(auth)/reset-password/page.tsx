    ...
    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
      {success ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {!token && (
            <div className="p-3 rounded-lg bg-yellow-500/20 border border-yellow-500/30 text-yellow-300 text-sm">
              Token no encontrado. Solicita un nuevo enlace de restablecimiento.
            </div>
          )}
