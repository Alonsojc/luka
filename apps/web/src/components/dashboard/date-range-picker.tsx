...
export function DateRangePicker({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 z-50 w-72 rounded-xl border border-border bg-card p-4 shadow-lg">
          ...
          <div className="border-t border-border/50 pt-3">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 rounded-lg border border-border bg-background text-foreground px-2 py-1.5 text-sm focus:border-black focus:outline-none focus:ring-1 focus:ring-black"
              />
